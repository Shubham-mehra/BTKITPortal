	...
	<div class = "container" style = "margin-top:200px">
		<div class = "row">
			<div class = "col-md-12 col-sm-12 col-xs-12">
				<center>
					<div class = "title">
						<h3 style = "color:#06a598">Electrical and Communication Engineering Faculty Details:</h3><br><br>
					</div>
				</center>	
			</div>
		</div>
		<p style="font-size:20px;">
		<p style="font-size:30px;">Electronics and Communication Engineering</p>
Electronics & Communication Engineering Department has excellent laboratory facilities in the field of Electronics & Communication Engineering. This department is accredited in 2006 by NBA AICTE for next 3 years. Department have state of the art laboratories. Rapid growth in the field of Electronics and Communication Engineering has a profound effect on modern society. Technological advances in personal communication such as mobile phone, satellite comm. etc. has led to exciting and diverse opportunities for employment for the telecommunication graduate.<br><br>


Head of the Department: Dr. R. K. Singh<br>
Phone (Head’s office) : +91-5966-24450<br>
Email :rksinghkec12@rediffmail.com<br><br><br>
